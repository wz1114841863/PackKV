...
cd figure
echo "==================== Figure 3, 4 ===================="
python kv_data_characteristic.py # < 1 min
echo "==================== Figure 3, 4 ===================="

echo "==================== Figure 6 ===================="
python repacking_visualization.py # < 1 min
echo "==================== Figure 6 ===================="
...
echo "==================== Figure 13 ===================="
python pack_size_cr_gen_setting.py # < 1 min
python pack_size_cr_run.py # < 20 mins
python figure/pack_size_cr.py # < 1 min
echo "==================== Figure 13 ===================="
...
python throughput_gen_setting_rtx_pro.py # < 1 min
python throughput_run_rtx_pro.py # < 10 mins
python figure/throughput_rtx_pro.py # < 1 min
echo "==================== Figure 15, 16 ===================="
...
python turning_point_cr_run.py
