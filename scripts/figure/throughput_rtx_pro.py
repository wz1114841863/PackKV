...
print("Generated RTX Pro throughput comparison plots in ./throughput/")
...
print("Generated RTX Pro kernel time breakdown pie charts in ./throughput/")

# Calculate and print our none kernel percentages
print("\n" + "="*50)
print("OUR NONE KERNEL PERCENTAGE ANALYSIS (RTX Pro)")
print("="*50)
...
print("\n" + "="*50)
print("AVERAGE PERFORMANCE IMPROVEMENT ANALYSIS (RTX Pro)")
print("="*50)
